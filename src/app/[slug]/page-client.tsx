...
export default function ProgramPageClient({ program, colors, slug }: ProgramPageClientProps) {
  const { t } = useLanguage()

  const steps = [
    { num: '01', titleKey: 'programLanding.step1', descKey: 'programLanding.step1desc', color: colors.accent },
    { num: '02', titleKey: 'programLanding.step2', descKey: 'programLanding.step2desc', color: colors.orange },
    { num: '03', titleKey: 'programLanding.step3', descKey: 'programLanding.step3desc', color: colors.green },
  ...
  return (
    <div className="min-h-screen" style={{ background: colors.bg, color: '#E6EDF3' }}>
      ...
      <div className="relative text-center py-20 px-6 overflow-hidden">
        ...
        <div className="relative">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-mono mb-6" style={{ background: `${colors.accent}1A`, border: `1px solid ${colors.accent}33`, color: colors.accent }}>
            ...
            {t('programLanding.applicationsOpen')}
          </div>
          ...
          >
            {t('programLanding.startInterview')}
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-bold mb-8">{t('programLanding.journey')}</h2>
            ...
            <div key={step.num} className="flex gap-5 items-start py-5 relative">
              ...
              <div>
                <h3 className="text-base font-semibold mb-1">
                  {'titleKey' in step ? t(step.titleKey as string) : step.title}
                </h3>
                <p className="text-sm text-[#8B949E] leading-relaxed">
                  {'descKey' in step ? t(step.descKey as string) : step.desc}
                </p>
              </div>
            </div>
          ))}
