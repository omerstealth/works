...
const translations = {
  tr: {
    ...
    'create.subtitle': 'AI mülakat ajanınızı birkaç dakikada kurun',
    'create.nameLabel': 'Program Adı',
    'create.namePlaceholder': 'ör. AI Startup Hızlandırıcı 2025',
    'create.nameHint': 'Adayların göreceği program adı',
    'create.slugHint': 'Mülakat linkiniz bu URL ile oluşturulur',
    'create.descLabel': 'Açıklama',
    'create.descPlaceholder': 'Programınızı kısaca tanımlayın...',
    'create.promptLabel': 'Mülakat Sistem Komutu',
    'create.promptHint': 'Varsayılan komut hazır — ileri kullanıcılar özelleştirebilir',
    'create.promptPlaceholder': 'AI mülakatçı için sistem komutunu yazın...',
    'create.resetPrompt': 'Varsayılana Sıfırla',
    'create.next': 'Devam Et',
    'create.back': 'Geri',
    'create.edit': 'Düzenle',
    'create.whatNext': 'OLUŞTURDUĞUNUZDA NE OLACAK?',
    'create.step1': 'AI mülakatçınız otomatik yapılandırılır',
    'create.step2': 'Adaylara paylaşabileceğiniz mülakat linki oluşturulur',
  ...
  en: {
    ...
    'create.subtitle': 'Set up your AI interview agent in minutes',
    'create.nameLabel': 'Program Name',
    'create.namePlaceholder': 'e.g. AI Startup Accelerator 2025',
    'create.nameHint': 'The name candidates will see',
    'create.slugHint': 'Your interview link will use this URL',
    ...
    'create.promptHint': 'Default prompt is ready — advanced users can customize',
    'create.promptPlaceholder': 'Write the system prompt for the AI interviewer...',
    'create.resetPrompt': 'Reset to Default',
    'create.next': 'Continue',
    'create.back': 'Back',
    'create.edit': 'Edit',
    'create.whatNext': 'WHAT HAPPENS WHEN YOU CREATE?',
    'create.step1': 'Your AI interviewer is automatically configured',
    'create.step2': 'An interview link is generated for candidates',
